...
/*   Updated: 2023/08/22 17:46:08 by djagusch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed	Fixed::operator*( Fixed const & rhs ) const
{
	...
	result.setRawBits(((long long)_value * (long long)rhs.getRawBits())>>_frac_bits);
	return ( result );
}
...
Fixed	Fixed::operator/( Fixed const & rhs ) const
{
	...
	result.setRawBits((((long long)_value) << _frac_bits) / (long long)rhs.getRawBits() );
	return ( result );
}
